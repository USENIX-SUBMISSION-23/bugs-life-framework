...
class ArtisanalBuildManager:
    ...
    def __init__(self, browser_build) -> None:
        self.logger = logging.getLogger("bci")
        self.browser_build = browser_build
        self.builds_folder_path = browser_build.artisanal_bin_folder_path
        self.executable_name = browser_build.executable_name
    ...
    def add_new_subfolders(self, subfolders):
        self.logger.info("Adding new subfolders to metadata")
    ...
    def remove_deleted_subfolders(self, subfolders):
        self.logger.info("Removing deleted subfolders from metadata")
    ...
    def recheck_validity_invalid_subfolders(self):
        self.logger.info("Recheck invalid subfolders and update metadata")
